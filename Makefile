.PHONY: setup test-basic test-dynamodb run-tests analyze clean help
...
help:
	...
	@echo   make test-basic        - basic load test
	@echo   make test-flash-sale   - flash sale load test
